  ...
  <el-container>
    <el-header height="150">
      <el-card style="height: 150px">
        <span class="examName">{{ examInfo.examName }}【{{examInfo.totalScore}}分】</span>
        ...
        <el-row style="margin-top: 55px;">
          ...
          <span v-if="examRecord.totalScore != null" style="float: right;font-weight: 800;font-size: 17px">
          总得分: {{ examRecord.totalScore }}分</span>
          </el-tooltip>
        </el-row>
    ...
    <el-main>
      <el-card>
        ...
        <div v-for="(item,index) in questionInfo" :key="index" style="margin-top: 15px">
          ...
          <!--简答题的答案-->
          <div style="margin-top: 25px" v-show="item.questionType === 5">
            <div class="ques-analysis">
